        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Trackings", x => new { x.FriendId, x.AccountId });
                    table.ForeignKey(
                        name: "FK_Trackings_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contents_AccountId",
                table: "Contents",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_Trackings_AccountId",
                table: "Trackings",
                column: "AccountId");
        }
